...
const EMAILJS_SERVICE_ID = 'service_recetario';
const EMAILJS_TEMPLATE_ID = 'template_recetario';
const EMAILJS_PUBLIC_KEY = 'YOUR_PUBLIC_KEY'; // Reemplazar con tu clave pública
